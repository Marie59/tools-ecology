...
ivr_scale %>%
  qu_tbl <- flextable()
qu_tbl <- bg(qu_tbl, i = 1, bg = "blue")
qu_tbl <- bg(qu_tbl, i = 2, bg = "olivedrab")
qu_tbl <- bg(qu_tbl, i = 3, bg = "yellow")
qu_tbl <- bg(qu_tbl, i = 4, bg = "gold1")
qu_tbl <- bg(qu_tbl, i = 5, bg = "orange1")
qu_tbl <- bg(qu_tbl, i = 6, bg = "red")

qu_tbl %>% autofit() %>% fit_to_width(7)
...
par(mar = c(5, 5, 4, 2) + 0.1)
  ...
  plot(df$Date, df$ivr.med, xlim = c(xmin_, xmax_), ylim = c(-0.2, 5.2), pch = 19, cex = 1, main = unique(df1$Site.bis), xlab = "Année", ylab = "IVR", col = "grey")
...
par(mar = c(5, 5, 4, 2) + 0.1)
  ...
  plot(df$Date, df$fr.r.med / 20, xlim = c(xmin_, xmax_), ylim = c(-0.2, 5.2), pch = 19, main = unique(df1$Site.bis), xlab = "", ylab = "", type = "n", axes = FALSE)
  ...
  par(new = TRUE)
  plot(df$Date, df$fr.r.med / 20, xlim = c(xmin_, xmax_), ylim = c(-0.2, 5.2), pch = 19, main = unique(df1$Site.bis), xlab = "Année", ylab = "IVR", col = "grey")
